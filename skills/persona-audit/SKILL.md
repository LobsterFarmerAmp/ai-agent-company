---
name: persona-audit
description: "Audit and simplify one agent's persona files; produce a review plan for the designated reviewer without editing files."
---

# Persona Audit

Use when Boss or the designated reviewer (e.g. architect) asks an agent to audit/simplify its own persona files.

## Hard rules

- Audit only YOUR own workspace. Never inspect or edit other agents' workspaces unless explicitly asked by the designated reviewer or Boss.
...
7. Send the plan to the designated reviewer for review. If cross-session messaging is unavailable, present the plan in your current reply.
...
Do not execute the plan unless the designated reviewer approves it later.
